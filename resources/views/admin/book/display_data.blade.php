        ...
        <div id="valid-data">
            ...
            @if (count($validDataResult) > 0)
                ...
                @if (count($validDataResult) > 10)
                    <p>...</p>
                @endif
                <a href="{{ route('admin.preview_import', ['name_file' => $fileValidResult]) }}" class="btn btn-primary">Import dữ liệu</a>
        ...
        <div id="invalid-data">
            ...
            @if (count($invalidDataResult) > 0)
                ...
                @if (count($invalidDataResult) > 10)
                    <p>...</p>
                @endif
                <a href="{{ route('admin.download_invalid_data', ['name_file' => $fileInvalidResult]) }}" class="btn btn-primary">Download</a>
            @else
